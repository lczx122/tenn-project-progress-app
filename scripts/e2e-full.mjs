...
// ---------- Dividers: seeded groups render; add / edit / delete ----------
check('divider: seeded headers render', await page.isVisible('text=Phase 2 — Main works'))
await page.click('text=+ Add divider')
await page.waitForTimeout(500)
await page.fill('input[placeholder="e.g. Phase 2 — Main works"]', 'Test Divider')
await page.selectOption('select[aria-label="Divider position"]', { label: 'Backdrop 03' })
await page.click('.sheet .primary-btn')
await page.waitForTimeout(600)
check('divider: add before item', await page.isVisible('text=Test Divider'))
await page.click('button[aria-label="Edit divider Test Divider"]')
await page.waitForTimeout(500)
await page.fill('input[placeholder="e.g. Phase 2 — Main works"]', 'Renamed Divider')
await page.click('.sheet .primary-btn')
await page.waitForTimeout(600)
check('divider: rename', await page.isVisible('text=Renamed Divider'))
await page.click('button[aria-label="Edit divider Renamed Divider"]')
await page.waitForTimeout(500)
await page.click('.sheet button:has-text("Delete divider")')
await page.click('.sheet button:has-text("Tap again to confirm")')
await page.waitForTimeout(2600)
...
await page.click('.card-hero:has-text("audit") >> text=Link to item')
await page.waitForTimeout(500)
...
check('project: new project starts blank', await page.isVisible('text=0 in progress · 0 of 0 items done'))
