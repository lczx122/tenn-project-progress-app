...
const CACHE_VERSION = 'tenn-bb-v6';
const APP_SHELL = [
  './',
  './index.html',
  './css/styles.css',
...
/* Cache-first for the app shell; network fallback keeps future assets working.
   Successful same-origin GETs are cached for offline use. */
